...
function AllProducts() {
  ...
  return (
    <div className="p-5 mx-auto  items-center justify-center ">
             <span className=" text-center text-blue-500 text-2xl font-semibold ">
         All Listed Products
        </span>
      <div className="mx-auto p-10 grid grid-cols-1 gap-y-10 gap-x-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8 ">
